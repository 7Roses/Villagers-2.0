...
import be.jroses.villagers2.aiengine.core.AIEngine;
import be.jroses.villagers2.aiengine.core.AgentMemory;
import be.jroses.villagers2.aiengine.core.Script;
import be.jroses.villagers2.aiengine.core.ScriptContainer;
import be.jroses.villagers2.aiengine.core.SensorScript;
...
public class GenericVillager extends EntityLiving {
	...
	protected void updateAITick() {
		...
		// super.updateAITick();
		System.out.println("been called!");
		System.out.println("have : " + this.sensorScripts.getScriptCount()
				+ "sensorScripts");
